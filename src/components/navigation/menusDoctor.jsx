...
<button ref={buttonRef} onClick={handleButtonClick} type="button" className="btn btn-success  rounded-pill text-white btn_imgcuenta ">
  ...
  <h6 className='col-8 text-truncate ' >{"Andre Herrera"} </h6>
      ...
      {true && (
        ...
        <div className="div-navbar bg-dark" >
                ...
                return (
                  <>
                    <button
                      ...
                      className={`w-100 d-block btn btn-dark text-white border-0 ${activeButton === index ? "active" : ""}`}
                      style={{
                        height: "50px",
                        borderRadius: "0px",
                        textAlign: "start",
                        ...
                        <div>
                          {value[1].map((value2, index2) => (
                            ...
                            <button
                              ...
                              className={`w-100 btn-dark btn d-block text-white border-0 ${(activeButton2 === index2 && activeButton === index) ? "active" : ""}`}
